...
public class AdapterDay2 extends RecyclerView.Adapter<AdapterDay2.ViewHolder> {
    ...
    public AdapterDay2(Context context, String[] event,String[] venue){
    ...
    public void onBindViewHolder(ViewHolder vholder, final int position) {
        ...
        else
        {
            ...
            imgurl = "drawable://" + (mcontext.getResources().getIdentifier("@drawable/item"+(position+6), "drawable", mcontext.getApplicationContext().getPackageName()));;
